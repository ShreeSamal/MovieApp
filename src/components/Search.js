        ...
        <div>
            <div className="displayMovie">
              <section className="text-gray-400 bg-gray-900 body-font overflow-hidden">
                <h1 className="text-green-400 text-3xl title-font font-medium mb-1 text-center" style={{align: "center"}}>Search Results</h1>
                <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-800 mb-5" style={mystyle}>
                </div>
                {movies.map((movie)=>
                <div className="container px-5 py-24 mx-auto">
                  <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="No Img" className="lg:w-1/2 w-full lg:h-auto h-64 object-center rounded" src={img_base + movie.poster_path}/>
